        ...
        {this.state.isAdmin ? <NavbarAdmin /> : <Navbar />}
          ...
          {!this.state.elStarted & !this.state.elEnded ? (
            <div className="container-item info">
              <center>
                {this.state.isAdmin ? (
                  <h3>To set up the election:
                    <h5>1. Go to 'Add Candidates' tab to add candidates.</h5>
                    <h5>2. Fill out the Admin registration form.</h5>
                    <h5>3. Click on 'Start Election' to begin election.</h5>
                  </h3>
                ) : (
                  <p>Please wait..</p>
                )}
